...
const debug = require('debug')('js-caching:Store:RethinkDB'),
      debug_internals = require('debug')('js-caching:Store:RethinkDB:Internals'),
      debug_events = require('debug')('js-caching:Store:RethinkDB:Events')
